...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Health IT Services Customer Portal" },
      { property: "og:description", content: "Secure customer support portal for GP IT Services customers." },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <PortalProvider><Outlet /><Toaster position="top-right" richColors /></PortalProvider>
    </QueryClientProvider>
  );
}
